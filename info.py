...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://msarkartrade:<uafXl7koaIVzNXUI>@movienstitute2.gnopjbx.mongodb.net/?retryWrites=true&w=majority&appName=Movienstitute2")
